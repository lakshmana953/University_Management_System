...
def send_otp_via_email(receiver_email):
    ...
    smtp_port = 587
    sender_email = "lakshmanabattula953@gmail.com"  # Replace with your email
    sender_password = "vico vweh dntc frwr"  # Replace with your email password or app password
